...
export default function ResumePage() {
  return (
    <>
      ...
      <div className="hidden print:block font-body text-[#111] leading-normal">
        {/* Header */}
        <div className="mb-6 pb-4 border-b border-[#ddd]">
          <h1 className="text-[36px] font-light tracking-tight text-[#0f0f0f] mb-1">
            Jane Molodetskaya
          </h1>
          <p className="text-[11px] uppercase tracking-[0.12em] text-[#6d28d9] mb-3 font-mono">
        ...
        {/* About */}
        <div className="mb-5">
          <p className="text-[12.5px] text-[#222] leading-[1.65]">
        ...
        {/* Skills */}
        <div className="mb-5">
          <p className="text-[10px] uppercase tracking-[0.18em] text-[#6d28d9] font-mono mb-2.5">Core Skills</p>
          <div className="flex flex-col gap-2">
            {STACK.map(([cat, val]) => (
              <div key={cat} className="grid grid-cols-[100px_1fr] gap-3 text-[11.5px]">
                <span className="text-[#888] font-mono text-[10px] pt-0.5">{cat}</span>
        ...
        {/* Experience */}
        <div className="mb-5">
          <p className="text-[10px] uppercase tracking-[0.18em] text-[#6d28d9] font-mono mb-3">Experience</p>
          ...
          <PrintJob company="Dapper Labs" role="Senior Software Engineer · Remote / Toronto" dates="May 2022 – Present">
            ...
            <p className="text-[10px] text-[#888] mt-1.5 font-mono">TypeScript, React, Next.js, React Native (Expo), GraphQL (Apollo), XState, TailwindCSS, TanStack Query</p>
          </PrintJob>
          ...
          <PrintJob company="Bunch" role="Full Stack Engineer" dates="Oct 2019 – Sep 2021">
            ...
            <p className="text-[10px] text-[#888] mt-1.5 font-mono">React Native, Redux Sagas, TypeScript, Jest/RTL, Firebase, Agora, Stream Chat</p>
          </PrintJob>
          ...
          <p className="text-[10px] text-[#aaa] font-mono mt-2">
        ...
        {/* Education */}
        <div>
          <p className="text-[10px] uppercase tracking-[0.18em] text-[#6d28d9] font-mono mb-2">Education</p>
          <p className="text-[13px] text-[#111]">Moscow Power Engineering Institute, Computer Programming, 2007–2010</p>
        </div>
      </div>
    </>
  )
  ...
  return (
    <div className="mb-4 break-inside-avoid">
      <div className="flex justify-between items-baseline flex-wrap gap-x-3 mb-0.5">
        <span className="text-[14px] font-medium text-[#0f0f0f]">{company}</span>
        <span className="text-[10px] text-[#aaa] font-mono">{dates}</span>
      </div>
      <p className="text-[10px] uppercase tracking-[0.08em] text-[#6d28d9] font-mono mb-1.5">{role}</p>
